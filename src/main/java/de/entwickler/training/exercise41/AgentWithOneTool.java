package de.entwickler.training.exercise41;
...
/**
 * Übung 41: Agent mit einem Tool (Qwen)
 *
 * Ziel: Die in Übung 40 entworfene Agenten-Grundstruktur implementieren und einen
 * einfachen Agenten erstellen, der genau ein vordefiniertes RooCode-Tool verwendet,
 ...
 * - Tool-Definition im System-Prompt (z.B. list_files)
 * - Tool-Parsing, Tool-Simulation, Ergebnis-Rückmeldung an LLM
 * - Erkennung der finalen Antwort
 *
 * Aufgabe:
 * 1. Konfiguriere die config.properties für das Qwen-3 32B Modell (wie in Übung 10)
 * 2. Implementiere die Agent-Klasse aus Übung 40 mit einem konkreten Tool (list_files)
 * 3. Implementiere die Methoden zur Verarbeitung der LLM-Antwort und zur Tool-Ausführung
 * 4. Gib dem Agenten die Aufgabe: "Liste die Dateien im Verzeichnis 'src' auf."
 * 5. Führe den Agenten aus und beobachte, wie er die Aufgabe löst
 *
...
public class AgentWithOneTool {
    ...
    public static void main(String[] args) {
        ...
        String initialPrompt = "Liste die Dateien im Verzeichnis 'src' auf.";
    ...
    /**
     * Agent-Klasse, die mit dem LLM interagiert und ein Tool verwendet, um eine Aufgabe zu lösen
     */
    static class Agent {
